...
#                 print(f"gan_actication layer {layer} shape {gan_activation.shape}")
...
#                 print(f"stats shape {batch_gan_stats[layer][iteration][0].shape,batch_gan_stats[layer][iteration][1].shape}")
...
#                 print(f"discr_actication layer {layer} shape {discr_activation.shape}")
...
#                 print(f"stats shape {batch_discr_stats[layer][iteration][0].shape,batch_discr_stats[layer][iteration][1].shape}")
        print("finished iterating for stats")
#         print(batch_gan_stats[gan_layers[0]][1])
