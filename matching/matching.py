        ...
        with torch.no_grad():
            ...
            for gan_layer in gan_layers:
                ...
                for discr_layer in discr_layers:
                    ...
                    gan_activ_new=gan_activ_new.permute(1,0,2,3).contiguous()
                    gan_activ_new=gan_activ_new.view(gan_activ_new.shape[0],-1)
                    
                    discr_activ_new=discr_activ_new.permute(1,0,2,3).contiguous()
                    discr_activ_new=discr_activ_new.view(discr_activ_new.shape[0],-1)
                    
                    
                    final_match_table[i:i+gan_activ.shape[1],j:j+discr_activ.shape[1]]+=gan_activ_new @ discr_activ_new.T/(map_size*map_size)
